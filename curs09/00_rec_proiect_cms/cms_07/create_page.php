...
//daca am selectat pagina, se va face operatie de update; altfel insert
if(isset($_GET['page'])){
		$action='update';
...
if(isset($_POST['submit'])){
	...
	if(empty($errors)){//daca nu am erori, procesez datele
		$subject_id = isset($_GET['subj'])?mysql_prep($_GET['subj']):'';
			...
			<form action="" method="post">
				...
				<p>Position: 
					<select name="position">
						<?php
							if($action=="insert"){
								$page_set = get_pages_for_subject($sel_subj['id'],false);
