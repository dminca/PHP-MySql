...
- Continutul paginii
	+--afisez (id-ul) numele subiectului sau paginii selectate
...
- content.php 
	...
	(nu)-memorarea id-ului subiectului sau paginii selectate
	...
	- continutul paginii
		(nu)-- afisez id-ul subiectului sau paginii selectate
		+-- afisez numele subiectului sau paginii selectate
		+-- pentru pagina afisez si continutul

	-includ footer.php
+- index.php
	-identic cu content.php
###########################
