...
<?php
/*
Un cookie se sterge folosind aceeasi parametri ca la setare, insa cu o data de expirare in trecut. 
...
setcookie('bg_color','',time()-30*$day);
unset($_COOKIE['bg_color']);
}

if(isset($_COOKIE['font_color'])){
setcookie('font_color','',time()-30*$day);
